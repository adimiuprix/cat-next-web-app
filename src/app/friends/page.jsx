    ...
    return(
        <div class="flex min-h-[calc(100vh-100px)] flex-col px-6">
            ...
            <div class="grid gap-3">
                ...
                <button onClick={linkReff} class="px-4 py-3 w-full font-bold text-white bg-gradient-to-r from-blue-400 to-blue-600 rounded-lg shadow-lg transition duration-300 hover:from-blue-500 hover:to-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
                    Invite friends
                </button>
